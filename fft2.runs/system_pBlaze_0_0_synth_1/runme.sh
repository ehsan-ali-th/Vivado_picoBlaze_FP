...
HD_PWD='D:/workspace/Vivado_2018.3/zcu104/fft2/fft2.runs/system_pBlaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pBlaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pBlaze_0_0.tcl
