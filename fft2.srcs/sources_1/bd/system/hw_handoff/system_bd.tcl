...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set pb_uart_cts [ create_bd_port -dir O -from 0 -to 0 pb_uart_cts ]
  set pb_uart_rx [ create_bd_port -dir I pb_uart_rx ]
  set pb_uart_tx [ create_bd_port -dir O pb_uart_tx ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_IS_DUAL {1} \
   CONFIG.GPIO2_BOARD_INTERFACE {dip_switch_4bits} \
  ...
  set block_name pBlaze
  set block_cell_name pBlaze_0
  if { [catch {set pBlaze_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: picoBlaze_prog0, and set properties
  set picoBlaze_prog0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 picoBlaze_prog0 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Feedback Clk##########I2C 1#I2C 1#UART 0#UART 0#####CAN 1#CAN 1##DPAUX#DPAUX#DPAUX#DPAUX###############SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#clk_for_lpbk##########scl_out#sda_out#rxd#txd#####phy_tx#phy_rx##dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in###############sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_1/BRAM_PORTA] [get_bd_intf_pins picoBlaze_prog0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports led_4bits] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports dip_switch_4bits] [get_bd_intf_pins axi_gpio_0/GPIO2]
  ...
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins pBlaze_0/external_mem_douta]
  connect_bd_net -net blk_mem_gen_2_doutb [get_bd_pins pBlaze_0/instruction] [get_bd_pins picoBlaze_prog0/doutb]
  connect_bd_net -net pBlaze_0_address [get_bd_pins pBlaze_0/address] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net pBlaze_0_bram_enable [get_bd_pins pBlaze_0/bram_enable] [get_bd_pins picoBlaze_prog0/enb]
  connect_bd_net -net pBlaze_0_external_mem_addra [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins pBlaze_0/external_mem_addra]
  connect_bd_net -net pBlaze_0_external_mem_dina [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins pBlaze_0/external_mem_dina]
  connect_bd_net -net pBlaze_0_external_mem_ena [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins pBlaze_0/external_mem_ena]
  connect_bd_net -net pBlaze_0_external_mem_wea [get_bd_pins blk_mem_gen_0/web] [get_bd_pins pBlaze_0/external_mem_wea]
  connect_bd_net -net pBlaze_0_irqs [get_bd_pins pBlaze_0/irqs] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net pBlaze_0_uart_top_tx [get_bd_ports pb_uart_tx] [get_bd_pins pBlaze_0/uart_top_tx]
  connect_bd_net -net pb_uart_rx_1 [get_bd_ports pb_uart_rx] [get_bd_pins pBlaze_0/uart_top_rx]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins picoBlaze_prog0/addrb] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports pb_uart_cts] [get_bd_pins xlconstant_0/dout]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins blk_mem_gen_0/wea] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins pBlaze_0/clk] [get_bd_pins picoBlaze_prog0/clkb] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn1 [get_bd_pins pBlaze_0/reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn1]
  ...
  create_bd_addr_seg -range 0x00004000 -offset 0xA4004000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
